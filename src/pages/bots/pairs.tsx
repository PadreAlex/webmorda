...
import InnerMMSettings, { MMSettings, skipMode } from '../inner/innerMMsettings';
...
const columns = [
    ...
    columnHelper.accessor('on_off_bot', {
        header: () => 'Is online',
        cell: (info) => info.getValue(),
    }),
];
...
export default function Users() {
    const [selectedUser, setSelectedUser] = useState<MMSettings>({ id: NaN } as MMSettings)
